...
run_test "$TEST_DIR/input_SL001.txt" "$TEST_DIR/input_SL001.output.txt" "Input SL001"
...
run_test "$TEST_DIR/input_HS014.txt" "$TEST_DIR/input_HS014.output.txt" "Input HS014"
