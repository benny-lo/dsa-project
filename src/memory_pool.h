...
typedef struct memory_pool_t {
  ...
  size_t size; // number of allocated pages - 1. the page with index size is the
               // last allocated page
...
bool memory_pool_request(memory_pool_t *pool, const char *request,
                         size_t request_size, size_t *base);
